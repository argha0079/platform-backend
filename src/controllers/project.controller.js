...
export const getProject = async (req, res, next) => {
    try {
        ...
        const project = await projectService.getProject(userId, projectId, userRole);
...
export const addMilestone = async (req, res, next) => {
    try {
        ...
        const milestone = await projectService.addMilestone(userId, projectId, {
            title,
            description,
            dueDate,
        });
...
export const listMilestones = async (req, res, next) => {
    try {
        ...
        const milestones = await projectService.listMilestones(userId, projectId);
...
export const updateMilestone = async (req, res, next) => {
    try {
        ...
        const milestone = await projectService.updateMilestone(userId, milestoneId, {
            title,
            description,
            status,
            dueDate,
